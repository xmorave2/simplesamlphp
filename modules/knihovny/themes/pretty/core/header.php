...
function changePageName() {
	var titledef = document.getElementsByTagName("fullname")[0];
	var titleToSet = titledef.getAttribute("value");
	titledef.remove();
	document.title = titleToSet;

	var h2 = document.getElementById("fullname");
	h2.textContent = titleToSet;
}
</script>
...
if($onLoad !== '') {
	$onLoad = ' onload="' . $onLoad . 'changePageName();"';
}
?>
